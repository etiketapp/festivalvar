...
class AdapterFestival(private val items : ArrayList<FestivalModel> = arrayListOf(), private val listener: FestivalClickListener) : RecyclerView.Adapter<FestivalViewHolder>() {
