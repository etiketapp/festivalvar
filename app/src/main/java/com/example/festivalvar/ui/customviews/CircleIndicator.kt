package com.example.festivalvar.ui.customviews
...
class CircleIndicator : LinearLayout {
    ...
    private var mIndicatorBackgroundResId = R.drawable.indicator_purple_radius

    private var mIndicatorUnselectedBackgroundResId = R.drawable.indicator_purple_radius
    ...
    private fun handleTypedArray(context: Context, attrs: AttributeSet?) {
        ...
        mIndicatorBackgroundResId =
            typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable, R.drawable.indicator_purple_radius)
    ...
    fun configureIndicator(
        ...
        @DrawableRes indicatorBackgroundId: Int = R.drawable.indicator_purple_radius,
        @DrawableRes indicatorUnselectedBackgroundId: Int = R.drawable.indicator_purple_radius
    ) {
    ...
    private fun checkIndicatorConfig(context: Context) {
        ...
        mIndicatorBackgroundResId =
            if (mIndicatorBackgroundResId == 0) R.drawable.indicator_purple_radius else mIndicatorBackgroundResId
        mIndicatorUnselectedBackgroundResId =
